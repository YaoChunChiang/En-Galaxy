function memRole(memNo){
    ...
    $.ajax({    
        ...
        success: function(rows){
            ...
            htmlStr += `<div class="clothEquip"><img src="${mems[2][0].equip_src.replace('.png','Wear.png')}" alt="我來組成防具" class="memRoleCloth"></div>`;
            htmlStr += `<div class="rolePart"><img src="${mems[0][0].set_part_src}" alt="我來組成不變色的部分" class="memRolePart"></div>`;
            htmlStr += `<div class="roleAccessory"><img src="${mems[3][0].equip_src.replace('.png','Wear.png')}" alt="我來組成飾品" class="memRoleAccessory"></div>`;
            ...
            htmlStr += `<div class="roleRightHand"><img src="${mems[0][0].set_righthand_src}" alt="我來組成右手" class="memRoleRightHand"  style="filter:hue-rotate(${mems[0][0].set_color}deg);"><div class="weaponEquip"><img src="${mems[1][0].equip_src.replace('.png','Wear.png')}" alt="我來組成武器" class="memRoleWeapon"></div></div>`;
