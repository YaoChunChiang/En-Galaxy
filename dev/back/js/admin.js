                ...
                if ((admin_account && admin_psw)) {
                    ...
                    $.ajax({
                        ...
                        success: function (getNoRows) {
                            ...
                            newAdmin += `<td><button type="button" class="btn btn-pill btn-primary btn-xl btnEditadmin">編輯</button></td><td><button type="button" class="btn btn-pill btn-danger btn-xl btnDelladmin">刪除</button></td>`;
                            newAdmin += `</tr>`;
                            $('#adminTable').append(newAdmin);
                            $('.newAdmin').remove();
                            alert('新增成功');
